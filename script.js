...
/* ──────────────────────────────────────────────
   ...
   All messages go directly to Utpreksha's WhatsApp
────────────────────────────────────────────── */
const formSubmit = document.getElementById('formSubmit');
const formNote   = document.getElementById('formNote');

// Utpreksha Kashyap - WhatsApp number India +91
const WA_NUMBER = '919335796380';
...
formSubmit.addEventListener('click', () => {
  ...
  const waText =
    encodeURIComponent(
      'Hi Utpreksha! I visited your portfolio.' + '\n\n' +
      'Name: ' + name + '\n' +
      'Email: ' + email + '\n\n' +
      'Message:\n' + msg
    );
  ...
  setTimeout(() => {
    ...
    formNote.textContent = '// WhatsApp opened! Message is pre-filled for you ✅';
    // Clear form
    setTimeout(() => {
